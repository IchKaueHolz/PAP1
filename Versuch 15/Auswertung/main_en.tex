...
\begin{equation}
    h_{eff} = \frac{h}{l} \cdot \left(l-11\si{\milli\meter}\right) = \qty{0.121(4)}{\meter}
    \end{equation}

The potential energy for the cylinders equals:
\begin{equation}
    E_{pot} = (\num{0.443(1)})\,\si{\kilo\gram} \cdot 9.81\,\si{\meter\per\second\squared} \cdot \qty{0.121(4)}{\meter} = \qty{0.524(18)}{\joule}
\end{equation}
