...
\begin{tcolorbox}[colback=gray!5,colframe=gray!60,boxrule=0.8pt,arc=0.01mm,title=KI-Hinweis]
    Für die sprachliche Formulierung dieses Protokolls wurde in Abschnitt \ref{Grundlagen} KI-gestützte Formulierungshilfen verwendet. Der Python-Code wurde zum Teil aus Frust mit KI korregiert. 
\end{tcolorbox}
