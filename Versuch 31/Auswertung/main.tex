...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        & [cm] & [cm] & [mm] & [mm] & & & \\
        \hline
        \multirow{3}{*}{$\infty > g > 2f$} & 25,0 & 16,5 & 8 & 5,0 & reel & umgekehrt & $0.6600\pm 0.0013 $ \\
        \cline{2-8}
        & 37,0 & 16 & 8 & 4,1 & r & u & $ $ \\
        \cline{2-8}
        & 40,85 & 14,5 & 8 & 2,5 & r & u & $ $ \\
        \hline
        $g = 2f$ & 20,0 & 19,4 & 8 & 8,0 & r & u & $ $ \\
        \hline
        \multirow{3}{*}{$2f > g > f$} & 13,9 & 33,9 & 8 & 20,0 & r & u & $ $ \\
        \cline{2-8}
        & 12,0 & 61,5 & 8 & 42,0 & r & u & $ $ \\
        \cline{2-8}
        & 16,0 & 26,3 & 8 & 13,0 & r & u & $ $ \\
        \hline
        $g = f$ & 10,0 & $\infty$ & 8 & $\infty$ & r & u & $ $ \\
        \hline
        $f > g$ & 9,0 & $\infty$ & 8 & $\infty$ & virtuell & aufrecht & $ $ \\
        \hline
    \end{tabular}
\end{table}


Das stimmt mit den Beobachtungen aus Tabelle \ref{tbl:pdftabelle-1} überein. 
Beispielrechnung: Für g = 25 cm und b = 16.5 cm ergibt sich $\beta = \frac{16.5}{25} = 0.66$\footnotemark.
\footnotetext{Die Unsicherheit würde nichts an $1 < \beta < 0$ ändern.}
Für g = 12 cm und b = 61.5 cm ergibt sich $\beta = \frac{61.5}{12} = 5.125$.

Die folgenden Skizzen zeigen die verschiedenen Strahlengänge für die verschiedenen Abbildungsfälle. Die Strahlen sind in der paraxialen Näherung gezeichnet, also nur für kleine Winkel zur optischen Achse. Die Strahlen, die von der Gegenstandsseite kommen, werden durch die Linse gebrochen und treffen sich auf der Bildseite. Die Strahlen, die von der Bildseite kommen, werden durch die Linse gebrochen und treffen sich auf der Gegenstandsseite.
...
\subsection{Aufgabe 2: Auswertung der Bessel-Messung}
