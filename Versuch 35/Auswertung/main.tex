...
Die Abgelesene Steigung der Ausgleichsgeraden beträgt $m = \qty{-5.5(9)e-15}{\text{V}}\cdot\text{s}$. Das Plancksche Wirkungsquantum berechnet sich aus der Steigung multipliziert mit der Elementarladung $e$:
\begin{equation}
    h = - m \cdot e = \qty{-5.5(9)e-15}{\text{V}}\cdot\text{s} \cdot \qty{1.602176634e-19}{\text{C}} = \qty{8.8(15)e-34}{\joule\second}
\end{equation}

\subsection{Vergleich mit dem Literaturwert}
Der Literaturwert des Planckschen Wirkungsquantums beträgt $h_\text{lit} = \qty{6.62607015e-34}{\text{J}}\cdot\text{s}$. Der relative Fehler der Messung beträgt:
\begin{equation}
