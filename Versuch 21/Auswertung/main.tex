...
Mithilfe der gegebenen Sättigungsdampfdrucktabelle für Wasser kann der Dampfdruck bei der gegebenen Temperatur interpoliert werden. Der Sättigungsdampfdruck des Wassers bei $T = \qty{22.5}{\celsius}$ beträgt $p_D^{H2O} \approx \qty{20.4(1.4)}{\text{Torr}} = \qty{27.7(1.8)}{\milli\bar}$. 
...
\begin{table}[H]
    ...
    \begin{tabular}{lc}
        ...
        Wertigkeit von Wasserstoff & $z = 1$ \\
