...
\begin{table}
    ...
    \begin{tabular}{lc}
        ...
        \textbf{Messwerte}\\
        \midrule
        Zeit des Stromflusses & $t = \qty{300(5)}{\second}$ \\
        Stromstärke & $I = \qty{0.500(10)}{\ampere}$ \\
        Volumen des abgeschiedenen Wasserstoffs & $V_{H2} = \qty{0.250(5)}{\liter}$ \\
        ...
        Umgebungsdruck & $p_L = p - 0.9 * p_D^{H2O} = 1013 - 0.9 * 23.8$\\
