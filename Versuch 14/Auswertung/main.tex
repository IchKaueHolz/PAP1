...
\begin{equation}
    \varphi_0 = \arcsin\left(\frac{A_0}{l}\right) = \arcsin\left(\frac{\qty{18.23(6)e-3}{\meter}}{\qty{97.31(14)e-2}{\meter}}\right) = \qty{1.874(7)e-2}{\radian}
\end{equation}

Der Korrekturterm für den Winkelausschlag beträgt somit:
\begin{equation}
    k_5 = \frac{\varphi_0^2}{8} = \frac{\qty{1.874(7)e-2}{\radian}^2}{8} = \num{4.388(28)e-5}
\end{equation}
