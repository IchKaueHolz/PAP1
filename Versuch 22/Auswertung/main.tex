...
\medskip
\noindent
Ein Vergleich mit Zeile 28 der generierten Auswertungstabelle zeigt, dass sämtliche handgerechneten Werte ($v_f = 4{,}219\cdot 10^{-5}\,\text{m/s}$, $v_s = 2{,}749\cdot 10^{-5}\,\text{m/s}$, $r_0 = 6{,}341\cdot 10^{-7}\,\text{m}$, $f(r_0) = 0{,}891$, $q = 1{,}521 \cdot 10^{-19}\,\text{As}$) exakt mit den Ausgabewerten von Excel übereinstimmen.
