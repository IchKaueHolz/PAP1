...
\begin{equation}
    J_\text{platte} = \frac{1}{2} m_s r_s^2
\end{equation}
...
Dasmit das Trägheitsmoment des Tisches $J_T$ abgezogen werden, um das Trägheitsmoment der Platte $J_\text{platte}$ zu erhalten. Das Trägheitsmoment des Tisches lässt sich aus der Schwingungsdauer des leeren Tisches $T_1 = \qty{1.21(3)}{\second}$ und dem Richtmoment $D$ berechnen:
\begin{equation}
