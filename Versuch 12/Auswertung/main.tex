...
\begin{align}
    ...
    \footnotemark &= \sqrt{\left(\frac{2\pi^2 r_\text{s}^2}{T_2^2 - T_1^2} \sigma_{m_\text{s}}\right)^2 + \left(\frac{4\pi^2 m_\text{s} r_\text{s}}{T_2^2 - T_1^2} \sigma_{r_\text{s}}\right)^2 + \left(\frac{8\pi^2 m_\text{s} r_\text{s}^2 T_1}{(T_2^2 - T_1^2)^2} \sigma_{T_1}\right)^2 + \left(\frac{8\pi^2 m_\text{s} r_\text{s}^2 T_2}{(T_2^2 - T_1^2)^2} \sigma_{T_2}\right)^2} 
\end{align}
...
\begin{equation}
    \sigma = \frac{|D_\text{statisch} - D_\text{dynamisch}|}{\sqrt{\sigma_{D_\text{statisch}}^2 + \sigma_{D_\text{dynamisch}}^2}} \Rightarrow 0.9\sigma
\end{equation}
