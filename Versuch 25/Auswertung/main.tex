...
Die einzelnen Frequenzen der Schwebung können mit folgender Formel berechnet werden:
\begin{equation}
    f_{1,2} = \frac{f_I + f_{II}}{2} \pm \frac{f_{II} - f_I}{2} \text{mit} f_I < f_{II}
\end{equation}

\medskip
mit den gemessenen Frequenzen Laut Abbildung \ref{fig:messprotokoll-5} im Messprotokoll:
\begin{itemize}
    \item $f_I = 1.395\pm 0.005\,\text{kHz}$
    \item $f_{II} = 1.580\pm 0.005\,\text{kHz}$
\end{itemize}

\begin{align*}
    f_1 &= \frac{1.395 + 1.580}{2} = 1.4875\,\text{kHz}\\
    f_2 &= \frac{1.580 - 1.395}{2} = 0.0925\,\text{kHz}
\end{align*}
