...
\begin{table}[H]
    ...
    \begin{tabular}{lc}
        ...
        Messsung & Wert\\
        \midrule
        Durchmesser 12mm: & $d_\text{12mm} = \qty{7.0(6)}{\centi\meter}$\\
        Durchmesser 24mm: & $d_\text{24mm} = \qty{5.4(6)}{\centi\meter}$\\
        Durchmesser ohne Küvette: & $d_0 = \qty{9.0(6)}{\centi\meter}$\\
...
\begin{equation}
    \epsilon = \frac{k'}{c} = \frac{(\num{0.121(18)})\si{\per\centi\meter}}{\qty{0.000001}{\mole\per\liter}} = \qty{1.21(18)e5e}{\liter\per\mole\per\centi\meter}
\end{equation}
...
\begin{resultbox}[Ergebnis der Längenmessung]
    ...
    \begin{equation*}
        \epsilon = \qty{1.21(18)e5}{\liter\per\mole\per\centi\meter}
    \end{equation*}
...
\begin{resultbox}[Ergebnis der Konzentrationsmessung]
    ...
    \begin{equation*}
        \epsilon = \qty{1.20(21)e5}{\liter\per\mole\per\centi\meter}
    \end{equation*}
\end{resultbox}
