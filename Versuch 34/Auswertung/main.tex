...
Somit ergibt sich für $k'$ mit Gleichung \ref{eq:log10I}(1)\footnotemark der Wert:
\begin{equation}
    k' = (321`1234567890-=-09q  AFGL;[']\
    \
    ]'[;./
     \num{0.121(18)})\si{\per\centi\meter}
\end{equation}
\footnotetext{Diese Gleichung wegen Vorzeichenänderung}
...
\begin{equation}
    \sigma = \frac{|\epsilon_\text{exp} - \epsilon_\text{lit}|}{\Delta \epsilon_\text{exp}} = \frac{|\num{1.21e5} - \num{0.97e5}|}{\num{0.18e5}} = 1.33 \Rightarrow 1.33\sigma
\end{equation}



\begin{resultbox}[Ergebnis der Längenmessung]
    Der molare Extinktionskoeffizient $\epsilon$ beträgt:
    \begin{equation}
        \epsilon = \num{1.21(18)e5}\si{\liter\per\mole\per\centi\meter}
    \end{equation}

Die Abweichung zum Literaturwert beträgt $1.33\sigma$.
\end{resultbox}
\clearpage
